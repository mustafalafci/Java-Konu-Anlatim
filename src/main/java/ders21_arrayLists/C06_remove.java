...
public class C06_remove {
    ...
    List<Integer> sayilar= new ArrayList<>();
        ...
        /*
        Listemiz integer'lardan olusuyorsa biz int bir deger yazdigimizda hep index olarak kabul ettiginden
        istedigimiz elementi obje olarak girip sildirmek icin onceden tanımlamamız gerekir
         */
        ...
        silinecekObje = 10;
        sayilar.remove(sayilar.remove(silinecekObje)); //false

        sayilar.remove(20); // IndexOfBound
